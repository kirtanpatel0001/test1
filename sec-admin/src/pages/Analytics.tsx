...
import { TrendingUp, DollarSign, ShoppingCart, Users, Eye, Calendar } from 'lucide-react';
...
const Analytics: React.FC = () => {
  ...
  const categoryData = [
    { name: 'Eyeglasses', value: 45, color: '#3B82F6' },
    { name: 'Sunglasses', value: 30, color: '#10B981' },
    { name: 'Contact Lenses', value: 15, color: '#F59E0B' },
    { name: 'Accessories', value: 10, color: '#EF4444' }
  ];

  const visitorsData = [
    { name: 'Mon', visitors: 1200, pageViews: 3400 },
    { name: 'Tue', visitors: 1500, pageViews: 4200 },
    { name: 'Wed', visitors: 1800, pageViews: 5100 },
    { name: 'Thu', visitors: 1600, pageViews: 4800 },
    { name: 'Fri', visitors: 2200, pageViews: 6300 },
    { name: 'Sat', visitors: 2800, pageViews: 7900 },
    { name: 'Sun', visitors: 2400, pageViews: 6800 }
  ];
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">₹{data?.stats.totalRevenue.toLocaleString() || 0}</p>
